...
<div class="form-wrapper">
    ...
    <input type="text" id="tags" name="_seobox_g_browser_title" value="<?php echo esc_attr( get_post_meta( get_the_ID(), '_seobox_g_browser_title', true ) ); ?>" placeholder="<?php esc_attr_e( 'Browser title', 'seobox' ); ?>"/>
