...
class Seobox {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Seobox_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Seobox_Loader. Orchestrates the hooks of the plugin.
	 * - Seobox_i18n. Defines internationalization functionality.
	 * - Seobox_Admin. Defines all hooks for the admin area.
	 * - Seobox_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Seobox_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Seobox_Loader    Orchestrates the hooks of the plugin.
	 */
