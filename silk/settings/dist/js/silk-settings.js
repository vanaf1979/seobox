...
/***/ "./silk/settings/src/js/modules/silkimages.js":
/*!****************************************************!*\
  !*** ./silk/settings/src/js/modules/silkimages.js ***!
  \****************************************************/
...
var silkimages = {
  ...
  start: function start() {
    $('.silk-image-upload-select').click(function (e) {
      e.preventDefault();
      var btEll = e.target;
      var frame = wp.media({
      ...
      frame.on('select', function () {
        ...
        var imgEll = $(btEll).parent().find('.silk-image-upload-src');
        imgEll.attr('src', attachment.sizes.thumbnail.url); // Set form hidden field value 

        var imgEll = $(btEll).parent().find('.silk-image-upload-field');
        imgEll.attr('value', attachment.id);
      });
    });
  },
  editImage: function editImage() {
    $('.silk-image-upload-edit').click(function (e) {
      e.preventDefault();
      ...
      var attachmentId = $(e.target).closest(".silk-image-upload-container").find('.silk-image-upload-field').attr('value');
      var frame = wp.media({
        title: 'Edit image',
        mode: 'edit',
...
module.exports = silkimages;

/***/ }),

/***/ "./silk/settings/src/js/modules/utils.js":
/*!***********************************************!*\
  !*** ./silk/settings/src/js/modules/utils.js ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "./silk/settings/src/js/silk-settings.js":
/*!***********************************************!*\
  !*** ./silk/settings/src/js/silk-settings.js ***!
  \***********************************************/
/*! no exports provided */
...
/* harmony import */ var _modules_utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/utils.js */ "./silk/settings/src/js/modules/utils.js");
...
/* harmony import */ var _modules_silkimages_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/silkimages.js */ "./silk/settings/src/js/modules/silkimages.js");
/* harmony import */ var _modules_silkimages_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_modules_silkimages_js__WEBPACK_IMPORTED_MODULE_1__);
/* Import utilities. */
...
_modules_utils_js__WEBPACK_IMPORTED_MODULE_0___default.a.domready(function () {
  _modules_silkimages_js__WEBPACK_IMPORTED_MODULE_1___default.a.init();
});
...
/***/ 1:
/*!*****************************************************!*\
  !*** multi ./silk/settings/src/js/silk-settings.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/saskia/Documents/repos/websites/wptest/wp-content/plugins/silk/silk/settings/src/js/silk-settings.js */"./silk/settings/src/js/silk-settings.js");
